...
- **Chrome / Chromium:** [radio-stream-extension-chrome.zip](https://github.com/jmicaux/radio-stream/releases/download/v0.4.6/radio-stream-extension-chrome.zip)
- **Firefox:** [radio-stream-firefox-v0.4.6.xpi](https://github.com/jmicaux/radio-stream/releases/download/v0.4.6/radio-stream-firefox-v0.4.6.xpi) — or the [.zip variant](https://github.com/jmicaux/radio-stream/releases/download/v0.4.6/radio-stream-firefox-v0.4.6.zip) if your browser tries to install the `.xpi` directly instead of downloading it.
...
4. For packaged testing, use `dist/v0.4.6/firefox/radio-stream-extension-firefox.zip`.
...
5. For packaged testing, use `dist/v0.4.6/chrome/radio-stream-extension-chrome.zip`.
